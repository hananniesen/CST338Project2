...
@Database(entities = {DiveLog.class, User.class, InstructorsClass.class}, version = 1, exportSchema = false)
public abstract class DiveLogDatabase extends RoomDatabase {
    ...
    public static final String INSTRUCTORS_TABLE = "instructortable";
    ...
    private static final RoomDatabase.Callback addDefaultValues = new RoomDatabase.Callback(){
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db) {
            ...
            databaseWriteExecutor.execute(() -> {
                ...
                User instructor = new User("instructor1", "instructor1");
